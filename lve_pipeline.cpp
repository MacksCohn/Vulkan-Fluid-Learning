...
namespace lve
{
    ...
    {
        assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot creae graphics handle: no pipelnelayourt");
        assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot creae graphics handle: no renderPass");
